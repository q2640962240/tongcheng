...
.stat-label { color: var(--by-text-3); font-size: 13px; margin-bottom: 6px; }
.stat-value { font-size: 24px; font-weight: 700; color: var(--by-text-1); }
.stat-value.gold { color: var(--by-gold-soft); }
